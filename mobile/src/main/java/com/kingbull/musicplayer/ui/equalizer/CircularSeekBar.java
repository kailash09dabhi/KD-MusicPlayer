...
public class CircularSeekBar extends View {
    ...
    /**
     * Minimum touch target screenSize in DP. 48dp is the Android design recommendation
     */
    ...
    protected static final int DEFAULT_CIRCLE_COLOR = Color.parseColor("#e4e4e4");
    protected static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.argb(255, 0, 156, 218);
     ...
     * If false, then the View itself determines the screenSize of the CircularSeekBar.
     */
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        float additionalRadius; // Either uses the minimumTouchTarget screenSize or larger if the ring/pointer is larger
